...
#define CONFIG_SLOT_A_ADDR              (QSPI_BASE_ADDR + 0x190000)
#define ADC_MAPPING_SLOT_A_ADDR         (QSPI_BASE_ADDR + 0x1A0000)

/* 槽位B地址定义 */
#define APPLICATION_SLOT_B_ADDR         (QSPI_BASE_ADDR + 0x1B0000)
#define WEB_RESOURCES_SLOT_B_ADDR       (QSPI_BASE_ADDR + 0x2B0000)
#define CONFIG_SLOT_B_ADDR              (QSPI_BASE_ADDR + 0x330000)
